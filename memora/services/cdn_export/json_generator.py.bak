...
def generate_manifest(plan_doc):
    ...
    subjects = frappe.get_all(
        ...
        fields=["name", "title", "description", "image", "color_code", "is_published"]  # "required_item" commented out
    )
...
def generate_subject_json(subject_doc, plan_id=None):
	...
	tracks = frappe.get_all(
		...
		fields=["name", "title", "description", "is_sold_separately", "parent_item_required"],  # "sort_order" and "required_item" commented out
		# order_by="sort_order"
